...
Route::group(['middleware' => ['jwt.verify:admin']], function () { //untuk hak akses admin dan petugas
	...
	Route::get('masyarakat/{id}', [MasyarakatController::class, 'getById']); //get by id
	...
	Route::get('petugas/{id}', [PetugasController::class, 'getById']); //get by id
...
Route::group(['middleware' => ['jwt.verify:admin,petugas']], function () {
	...
	Route::get('pengaduan/{id_pengaduan}', [PengaduanController::class, 'getById']); //get by id pengaduan
